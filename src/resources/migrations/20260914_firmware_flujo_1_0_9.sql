...
SELECT (SELECT COALESCE(MAX(id),0)+1 FROM versiones_firmware),'1.0.9','ESP32','riego_flujo',
'Cierre estricto por tiempo planificado y control manual sin apagado por ausencia de flujo; version 1.0.9',
'{"schema_version": 1, "version": "1.0.9", "chip": "ESP32", "tipo_dispositivo": "riego_flujo", "source_sha256": "94bae144b1a6cfb470ccff3ef56cf0d4deea7404cba136c589a2631c51d9bccc", "segmentos": [{"nombre": "esp32-sensor-flujo.ino.bootloader.bin", "direccion": 4096, "tamano": 24992, "sha256": "427f96e10c620c4f062dab15da54fc45494d897e8397ae6f3aecc98c42d7e379"}, {"nombre": "esp32-sensor-flujo.ino.partitions.bin", "direccion": 32768, "tamano": 3072, "sha256": "148b959cbff1c38aa8e1d5c0ba9d612c54997b945e56a63f41223eef650653a1"}, {"nombre": "boot_app0.bin", "direccion": 57344, "tamano": 8192, "sha256": "f94c5d786a7a8fab06ac5d10e33bf37711a6697636dc037559ea19cc410a17f0"}, {"nombre": "esp32-sensor-flujo.ino.bin", "direccion": 65536, "tamano": 1048080, "sha256": "03054fd78dd9f506d7ce08248c80beecd1743e56ad2bf78742b39ee2a836dd0f"}]}'::jsonb,'esp32-flujo-1.0.9','firmware_store/esp32-flujo-1.0.9',true,false,
(SELECT MIN(id) FROM usuarios WHERE id_rol=1)
WHERE EXISTS (SELECT 1 FROM usuarios WHERE id_rol=1) AND NOT EXISTS
(SELECT 1 FROM versiones_firmware WHERE version='1.0.9' AND chip='ESP32' AND tipo_dispositivo='riego_flujo');
